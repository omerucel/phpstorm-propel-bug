...
abstract class BookQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'starterkit', $modelName = '\\Application\\Entity\\Book', $modelAlias = null)
    {
    ...
    {
        if ($criteria instanceof \Application\Entity\BookQuery) {
            return $criteria;
        }
        $query = new \Application\Entity\BookQuery();
        if (null !== $modelAlias) {
    ...
    {
        $sql = 'SELECT ID, TITLE FROM book WHERE ID = :p0';
        try {
