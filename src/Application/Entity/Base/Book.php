...
abstract class Book implements ActiveRecordInterface
{
     ...
     * @return   \Application\Entity\Book The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException("Error populating \Application\Entity\Book object", 0, $e);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BookTableMap::COL_ID)) $criteria->add(BookTableMap::COL_ID, $this->id);
        if ($this->isColumnModified(BookTableMap::COL_TITLE)) $criteria->add(BookTableMap::COL_TITLE, $this->title);
